...
private fun writeCount(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default java.lang.Long count${classModel.methodsSuffix}(CountContextConsumer consumer) {""")
...
private fun writeList(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default java.util.List<${classModel.dtiName}> list${classModel.methodsSuffix}(ListContextConsumer consumer) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(consumer);""")
    bufferedWriter.appendLine("""        jakarta.persistence.criteria.CriteriaBuilder criteriaBuilder = this.getEntityManager().getCriteriaBuilder();""")
...
private fun writeFind(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    ...
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default void find${classModel.methodsSuffix}(${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        find${classModel.methodsSuffix}(data, jakarta.persistence.LockModeType.OPTIMISTIC);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default void find${classModel.methodsSuffix}(${classModel.dtiName} data, jakarta.persistence.LockModeType lockMode) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(lockMode);""")
    bufferedWriter.appendLine("""        if (!tryFind${classModel.methodsSuffix}(data, lockMode)) {""")
    bufferedWriter.appendLine("""            throw new IllegalArgumentException("Entity Not Found");""")
    bufferedWriter.appendLine("""        }""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default boolean tryFind${classModel.methodsSuffix}(${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        return tryFind${classModel.methodsSuffix}(data, jakarta.persistence.LockModeType.OPTIMISTIC);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default boolean tryFind${classModel.methodsSuffix}(${classModel.dtiName} data, jakarta.persistence.LockModeType lockMode) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(lockMode);""")
...
private fun writeCreate(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default void create${classModel.methodsSuffix}(${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
...
private fun writeUpdate(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    val idPropertyModel = classModel.idProperty ?: return
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default void update${classModel.methodsSuffix}(${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        update${classModel.methodsSuffix}(data, jakarta.persistence.LockModeType.OPTIMISTIC);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default void update${classModel.methodsSuffix}(${classModel.dtiName} data, jakarta.persistence.LockModeType lockMode) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(lockMode);""")
    bufferedWriter.appendLine("""        if (!tryUpdate${classModel.methodsSuffix}(data, lockMode)) {""")
    bufferedWriter.appendLine("""            throw new IllegalArgumentException("Entity Not Found");""")
    bufferedWriter.appendLine("""        }""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default boolean tryUpdate${classModel.methodsSuffix}(${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        return tryUpdate${classModel.methodsSuffix}(data, jakarta.persistence.LockModeType.OPTIMISTIC);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default boolean tryUpdate${classModel.methodsSuffix}(${classModel.dtiName} data, jakarta.persistence.LockModeType lockMode) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(lockMode);""")
    bufferedWriter.appendLine("""        ${classModel.qualifiedName} entity = this.getEntityManager().find(${classModel.qualifiedName}.class, data.${idPropertyModel.getterName}(), lockMode);""")
    bufferedWriter.appendLine("""        if (entity == null) {""")
...
private fun writeDelete(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    val idPropertyModel = classModel.idProperty ?: return
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default void delete${classModel.methodsSuffix}(${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        delete${classModel.methodsSuffix}(data, jakarta.persistence.LockModeType.OPTIMISTIC);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default void delete${classModel.methodsSuffix}(${classModel.dtiName} data, jakarta.persistence.LockModeType lockMode) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(lockMode);""")
    bufferedWriter.appendLine("""        if (!tryDelete${classModel.methodsSuffix}(data, lockMode)) {""")
    bufferedWriter.appendLine("""            throw new IllegalArgumentException("Entity Not Found");""")
    bufferedWriter.appendLine("""        }""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default boolean tryDelete${classModel.methodsSuffix}(${classModel.dtiName} data) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        return tryDelete${classModel.methodsSuffix}(data, jakarta.persistence.LockModeType.OPTIMISTIC);""")
    bufferedWriter.appendLine("""    }""")
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    default boolean tryDelete${classModel.methodsSuffix}(${classModel.dtiName} data, jakarta.persistence.LockModeType lockMode) {""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(data);""")
    bufferedWriter.appendLine("""        java.util.Objects.requireNonNull(lockMode);""")
    bufferedWriter.appendLine("""        ${classModel.qualifiedName} entity = this.getEntityManager().find(${classModel.qualifiedName}.class, data.${idPropertyModel.getterName}(), lockMode);""")
    bufferedWriter.appendLine("""        if (entity == null) {""")
...
private fun writeCountContext(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    class CountContext extends mx.com.inftel.codegen2.CountContext<${classModel.qualifiedName}> {""")
    bufferedWriter.appendLine("""""")
...
private fun writeListContext(bufferedWriter: BufferedWriter, classModel: ClassModel) {
    bufferedWriter.appendLine()
    bufferedWriter.appendLine("""    class ListContext extends mx.com.inftel.codegen2.ListContext<${classModel.qualifiedName}> {""")
    bufferedWriter.appendLine("""""")
